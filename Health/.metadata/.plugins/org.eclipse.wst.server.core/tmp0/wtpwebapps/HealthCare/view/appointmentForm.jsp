...
<title>Schedule Appointment | HealthCare</title>
        ...
        <nav class="top-nav">
            <div class="nav-container">
                ...
                <ul class="nav-menu" id="navMenu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/AppointmentListServlet" class="nav-link active">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <div class="breadcrumb">
                    ...
                    <a href="${pageContext.request.contextPath}/AppointmentListServlet">Appointments</a>
                    <span class="separator">/</span> 
            ...
            <div class="appointment-form">
                <form action="${pageContext.request.contextPath}/AddAppointmentServlet" method="post">
                    ...
                    <div class="form-actions">
                        <a href="${pageContext.request.contextPath}/AppointmentListServlet" class="btn btn-secondary">
