...
public class AppointmentDao {
	...
	public boolean addAppointment(Appointment appointment) throws SQLException {
	    System.out.println("DEBUG: Adding new appointment - Patient ID: " + appointment.getPatientId() + 
	    ...
	    try (Connection connection = DBUtil.getConnection();
	        ...
	        System.out.println("DEBUG: Appointment added successfully: " + result);
	        return result;
	    }
	}
 ...
 // In AppointmentDao.java
    ...
    public List<Appointment> getPatientAppointments(int patientId) throws SQLException {
        List<Appointment> appointments = new ArrayList<>();
        String sql = "SELECT a.appointment_id, a.date, a.time, a.status, " +
                     "d.name AS doctor_name, d.specialization " +
                     "FROM appointments a " +
                     "JOIN doctors d ON a.doctor_id = d.doctor_id " +
                     "WHERE a.patient_id = ? " +
    ...
    public List<Appointment> getPendingAppointments(int doctorId) throws SQLException {
        System.out.println("Fetching pending appointments for doctor ID: " + doctorId);
        ...
        try (Connection connection = DBUtil.getConnection();
            ...
            try (ResultSet resultSet = statement.executeQuery()) {
                while (resultSet.next()) {
                    ...
                    System.out.println("Found appointment for patient: " + 
