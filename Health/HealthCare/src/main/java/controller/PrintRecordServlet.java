...
public class PrintRecordServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!"doctor".equals(user.getRole())) {
            response.sendError(HttpServletResponse.SC_FORBIDDEN, "Only doctors can print records");
            return;
        }
        ...
        try {
            ...
            if (record != null) {
                ...
                request.getRequestDispatcher("/view/printRecord.jsp").forward(request, response);
            } else {
