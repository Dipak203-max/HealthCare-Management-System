...
<div class="main-container">
    ...
    <div class="welcome-container">
        ...
        <div class="hospital-image">
            <img src="images/3.avif" alt="Modern Hospital Building">
        </div>
    </div>
    ...
    <div class="card-container">
        <div class="card">
            <div class="card-header">
                <span class="card-title">Make Appointment</span>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                <span class="card-title">Medical Records</span>
            </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <span class="card-value">${prescriptionsCount}</span>
            </div>
    ...
    <div class="appointments-section">
        ...
        <div class="card-header">
            ...
            <span class="card-value">${upcomingAppointmentsCount}</span>
        </div>
        ...
        <c:forEach var="appointment" items="${upcomingAppointments}">
            <div class="appointment-card">
                ...
                <div>
                    <fmt:formatDate value="${appointment.date}" pattern="EEE, MMM d" />, 
                    <fmt:formatDate value="${appointment.time}" pattern="h:mm a" />
                </div>
            </div>
        </c:forEach>
        
        <c:if test="${empty upcomingAppointments}">
            <div style="padding: 20px; text-align: center; background-color: var(--light-color); border-radius: 8px;">
                No upcoming appointments found. Would you like to <a href="${pageContext.request.contextPath}/ScheduleAppointmentServlet" style="color: var(--accent-color);">schedule one</a>?
            </div>
        </c:if>
    </div>
</div>
...
<!-- Font Awesome for icons (add this in head for real implementation) -->
