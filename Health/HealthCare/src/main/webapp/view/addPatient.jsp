        ...
        <nav class="top-nav">
            <div class="nav-container">
                ...
                <ul class="nav-menu" id="navMenu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/PatientListServlet" class="nav-link active">
        ...
        <main class="main-content">
            <div class="page-header">
                ...
                <div class="breadcrumb">
                    ...
                    <a href="${pageContext.request.contextPath}/PatientListServlet">Patients</a>
                    <span class="separator">/</span> 
                    <span>Add New</span>
                </div>
            </div>
            ...
            <div class="add-form-container">
                <div class="form-header">
                    <h3><i class="fas fa-procedures"></i> Patient Information</h3>
                    <p>Please fill in the details for the new patient</p>
                </div>
                ...
                <form action="${pageContext.request.contextPath}/AddPatientServlet" method="post">
                    ...
                    <div class="form-actions">
                        <a href="${pageContext.request.contextPath}/PatientListServlet" class="btn btn-secondary">
