...
<body>
    <div class="dashboard-container">
        ...
        <nav class="top-nav">
            <div class="nav-container">
                ...
                <ul class="nav-menu" id="navMenu">
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/DoctorListServlet" class="nav-link active">
        ...
        <main class="main-content">
            ...
            <a href="${pageContext.request.contextPath}/view/addNewDoctor.jsp" class="add-btn">
                        ...
                        <c:forEach var="doctor" items="${doctors}">
                            <tr>
                                ...
                                <td class="actions-cell">
                                    <a href="${pageContext.request.contextPath}/EditDoctorServlet?id=${doctor.doctorId}"
                                       class="action-btn edit-btn">
                                       <i class="fas fa-edit"></i>
                                       <span>Edit</span>
                                    </a>
                                    
                                    <form action="${pageContext.request.contextPath}/DeleteDoctorServlet"
        ...
        <footer class="footer">
            <div class="footer-content">
                ...
                <div class="copyright">
                    &copy; 2023 HealthCare Admin. All rights reserved.
                </div>
            </div>
        </footer>
    </div>
